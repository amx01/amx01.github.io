...
texts = [
  {key:"repro",file:"repro.csv",name:"All Word Frequencies"}
  {key:"repro2",file:"repro2.csv",name:"Word Frequencies of 2 or above"}
  {key:"repro3",file:"repro3.csv",name:"Word Frequencies of 3 or above"}
  ]
